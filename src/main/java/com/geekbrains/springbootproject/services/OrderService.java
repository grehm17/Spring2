...
public class OrderService {
    ...
    public boolean havebeenOrdered(Product product,User user){
        ArrayList<OrderItem> orderList = (ArrayList<OrderItem>) orderRepository.findByUserProduct(product,user);
