...
CREATE TABLE `categories` (
  ...
  KEY `iii_idx` (`parent`),
  CONSTRAINT `iii` FOREIGN KEY (`parent`) REFERENCES `categories` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `comments` (
  ...
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`),
  KEY `cm_prod_idx` (`product_id`),
  KEY `cm_user_idx` (`user_id`),
  CONSTRAINT `cm_prod` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `cm_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `properties` (
  ...
  `title` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `elem_prop_idx` (`elem_id`),
  CONSTRAINT `elem_prop` FOREIGN KEY (`elem_id`) REFERENCES `elements` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `category_property` (
  ...
  PRIMARY KEY (`id`),
  KEY `property_cp_idx` (`property_id`),
  KEY `category_cp_idx` (`category_id`),
  CONSTRAINT `category_cp` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `property_cp` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;



INSERT INTO categories (title,level)
VALUES
('FIRST',0);
